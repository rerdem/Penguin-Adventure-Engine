...
struct qt_meta_stringdata_inventoryScreen_t {
    QByteArrayData data[1];
    char stringdata[17];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_inventoryScreen_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_inventoryScreen_t qt_meta_stringdata_inventoryScreen = {
    {
...
const QMetaObject inventoryScreen::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_inventoryScreen.data,
      qt_meta_data_inventoryScreen,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_inventoryScreen.stringdata))
